              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Terima kasih telah melakukan pendaftaran di SMAN 1 TAKENGON. Pengumuman pada tanggal: </p>
                    <span class="badge badge-danger" style="font-size: 20px;">1 Maret 2025</span>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">SMAN 1 TAKENGON</marquee>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Selamat anda lolos seleksi di SMAN 1 TAKENGON. Lakukan Daftar Ulang pada tanggal: </p>
                    <span class="badge badge-danger" style="font-size: 20px;">27 Februari 2025</span>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">SMAN 1 TAKENGON</marquee>
                  </div>
        ...
        <div class="col-md-12">
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <p class="text-danger mt-3">* Wajib melakukan Daftar Ulang pada tanggal: 15 Januari 2025</p>
            </div>
          </div>
        </div>
