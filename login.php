...
<head>
  ...
  <meta name="description" content="Aplikasi pendaftaran Siswa SMAN 1 TAKENGON.">
  <meta name="author" content="e-development.tech">

  <title>Login Aplikasi Pendaftaran Siswa</title>

  <!-- gambar title -->
  <link rel="icon" type="image/png" href="assets/img/logosekolah.png">
              ...
              <div class="col-md-12">
                <div class="p-5">
                  <div class="text-center">
                    <img src="assets/img/logosekolah.png" alt="Logo sekolah" class="logo-login">

                    <h1 class="h4 text-gray-900">Aplikasi Pendaftaran Siswa</h1>
                    <h1 class="h4 text-gray-900 mb-4"><b>SMAN 1 TAKENGON</b></h1>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="registrasi.php">Belum memiliki akun? Registrasi disini!</a>
                  </div>
                </div>
              </div>
            </div>
